...
class MCQController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.mcqs.sets.index', compact('mcqSets'));
    }
    ...
    {
        return view('admin.mcqs.sets.create');
    }
    ...
    public function show(McqSet $mcqSet)
    {
        ...
        return view('admin.mcqs.sets.show', compact('mcqSet'));
    }
    ...
    public function edit(McqSet $mcqSet)
    {
        ...
        return view('admin.mcqs.sets.edit', compact('mcqSet'));
    }
    ...
    public function showImport(Request $request)
    {
        ...
        return view('admin.mcqs.sets.import', compact('existingSets', 'targetSet'));
    }
