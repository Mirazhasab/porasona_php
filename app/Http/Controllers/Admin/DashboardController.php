...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $recentExams = McqSet::with('user')->latest()->limit(5)->get();
        $recentPosts = Post::with('user')->latest()->limit(5)->get();
        
        return view('admin.dashboard', compact('stats', 'user', 'recentUsers', 'recentExams', 'recentPosts'));
    }
    ...
    public function questions()
    {
        ...
        return view('admin.questions', compact('questionsQuery', 'user', 'stats'));
    }
    ...
    public function examinations()
    {
        ...
        return view('admin.examinations', compact('examinations', 'user'));
    }
    ...
    public function analytics()
    {
        ...
        return view('admin.analytics', compact('examResults', 'stats', 'user'));
    }
    ...
    public function students()
    {
        ...
        return view('admin.students', compact('students', 'user'));
    }
    ...
    public function leaderboard()
    {
        ...
        return view('admin.leaderboard', compact('leaderboardData', 'stats', 'user'));
    }
    ...
    public function viewExam($id)
    {
        ...
        return view('admin.view-exam', compact('mcqSet', 'user'));
    }
    ...
    public function showResults($id)
    {
        ...
        if ($userAnswers->isEmpty()) {
            return redirect()->route('mcq.examinations')
                ->with('error', 'You have not taken this exam yet.');
        }
        ...
        return view('admin.exam-results', compact('mcqSet', 'userAnswers', 'statistics', 'user'));
    }
    ...
    public function read()
    {
        ...
        return view('admin.read', compact('mcqSets', 'stats', 'user'));
    }
    ...
    public function readContent(McqSet $mcqSet)
    {
        ...
        $stats = [
            ...
            'difficulty' => 'Intermediate', // Could be calculated based on question complexity
            'hasAttempted' => $userAnswers->count() > 0,
            'lastAttempted' => $userAnswers->count() > 0 ? $userAnswers->first()->created_at : null
        ];
        
        return view('admin.read-content', compact('mcqSet', 'stats', 'user', 'userAnswers'));
    }
}
